...
class Display:
    ...
    def intro(self):
        output = self.SH_YELLOW + ("""
           ...
           __    _ ______________          __    __    ____          _____ ____ 
 _      __/ /_  (_) ____/_  __/ /__       / /_  / /   / __ \_      _|__  // __ \
| | /| / / __ \/ /___ \  / / / / _ \     / __ \/ /   / / / / | /| / //_ </ /_/ /
| |/ |/ / / / / /___/ / / / / /  __/    / /_/ / /___/ /_/ /| |/ |/ /__/ / _, _/ 
|__/|__/_/ /_/_/_____/ /_/ /_/\___/____/_.___/_____/\____/ |__/|__/____/_/ |_|  
                                 /_____/                                          
""" if random() > 0.5 else """

   ____  _          _ _ _         _____  _                       
  / __ \( )        (_) | |       |  __ \(_)                      
 | |  | |/ _ __ ___ _| | |_   _  | |__) |_ _ __  _ __   ___ _ __ 
 | |  | | | '__/ _ \ | | | | | | |  _  /| | '_ \| '_ \ / _ \ '__|
 | |__| | | | |  __/ | | | |_| | | | \ \| | |_) | |_) |  __/ |   
  \____/  |_|  \___|_|_|_|\__, | |_|  \_\_| .__/| .__/ \___|_|   
                           __/ |          | |   | |              
                          |___/           |_|   |_|                                                        
""") + self.SH_DEFAULT
        output += "\n" + "~" * (self.columns // 2)
    ...
    def done(self, epub_file):
        self.info("Done: %s\n\n" % epub_file +
                  ...
                  "      @whi5tLe_bL0w3R\n"
                  "        " + SAFARI_BASE_URL + "\n\n" +
                  self.SH_BG_RED + "[!]" + self.SH_DEFAULT + " Enjoy reading the book!")
